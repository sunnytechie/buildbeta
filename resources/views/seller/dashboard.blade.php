    ...
    <div class="dashboard-content mb-5">
        ...
        <div class="row mt-5">
            <div class="col-md-12 d-flex justify-content-between">
                <h5 style="font-family: 'Poppins'; font-style: normal; font-weight: 500; font-size: 16px; line-height: 160%; letter-spacing: -0.3px; color: #000000;">My Products & Services</h5>
                <a href="#" class="mr-5" style="font-family: 'Poppins'; font-style: normal; font-weight: 400; font-size: 12px; line-height: 160%; color: #0080E6; letter-spacing: -0.3px;">View all</a>
            </div>
