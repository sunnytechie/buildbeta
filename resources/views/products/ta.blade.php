<section class="featured-products-section">
    <div class="container">
        <h2 class="section-title my-3 mt-1" style="font-style: normal; font-weight: 500; font-size: 16px; line-height: 160%; text-transform:capitalize">Category 1</h2>
        ...
        @foreach ($productWithId1 as $product)
        <div class="product-default appear-animate shadow-md" data-animation-name="fadeInRightShorter">
            ...
            <button class="btn p-1" style="position: absolute; margin-top: -45px; margin-left: 8px; background: #0080E6; color: #fff; line-height: 16px; font-size: 10px; text-transform: capitalize; font-weight: 600">{{ $product->category->title }}</button>
