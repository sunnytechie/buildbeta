                    ...
                    <div class="card-body">
                      <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                {{-- header --}}
                                <h6 class="card-subtitle mb-2" style="font-family: 'Poppins'; font-style: normal; font-weight: 500; font-size: 14px; line-height: 160%; letter-spacing: -0.3px; color: #000000;">Grade</h6>
                                {{-- header --}}
