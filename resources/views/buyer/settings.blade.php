            ...
            <div class="d-flex my-4 justify-content-between">
                <div class="d-flex">
                    ...
                    <div class="mt-1">
                        ...
                        <span
                            style="font-family: 'Poppins'; font-style: normal; font-weight: 400; font-size: 12px; line-height: 160%; letter-spacing: -0.3px; color: #000000;">Buyer</span>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <form action="#" method="POST">
                        <div class="form-group">
                            ...
                            <small id="nameHelp" class="form-text text-muted">Please make sure to use your legal
                                fullname</small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="username" class="form-control" id="exampleInputusername1"
                                aria-describedby="usernameHelp" placeholder="Username" value="{{ Auth::user()->username }}">
                        ...
                        <div class="form-group">
                            ...
                            <small id="phoneHelp" class="form-text text-muted">Please make sure to use your legal phone
                                number</small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputtext1"
                                aria-describedby="textHelp" placeholder="State" value="{{ Auth::user()->state }}">
                            <small id="textHelp" class="form-text text-muted">Your personal or office line</small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputtext1"
                                aria-describedby="textHelp" placeholder="City" value="{{ Auth::user()->city }}">
                            <small id="textHelp" class="form-text text-muted">Your personal or office line</small>
                        </div>

                        <button class="btn p-3 btn-sm bb-bg-btn w-100"
                            style="text-transform: capitalize; font-family: 'Poppins'; font-style: normal; font-weight: 400; font-size: 14px; line-height: 160%; letter-spacing: -0.3px;">Update</button>
                    </form>
                </div>

                <div class="col-md-4">
                    <button class="btn mb-2 p-3 bb-bg-btn w-100 show-only-mobile" onclick="businessInfoFunction();"
                        style="text-transform: capitalize; font-family: 'Poppins'; font-style: normal; font-weight: 400; font-size: 14px; line-height: 160%; letter-spacing: -0.3px;">Payment
                        Option</button>
                    ...
                    <form id="businessInfo" action="#" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputText" aria-describedby="textHelp"
                                placeholder="Bank Name" value="{{ Auth::user()->business_bank_name }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputText" aria-describedby="textHelp"
                                placeholder="Bank Account" value="{{ Auth::user()->business_bank_account }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputText" aria-describedby="textHelp"
                                placeholder="Bank Branch" value="{{ Auth::user()->business_bank_branch }}">
