    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal " href="/">
                <img src="{{ asset('general/imgs/BUILDBETA_LOGO_PNG.png') }}" class="header-brand-img desktop-logo" alt="logo" style="width: 40px; height: 40px">
                <img src="{{ asset('general/imgs/BUILDBETA_LOGO_PNG.png') }}" class="header-brand-img light-logo1" alt="logo" style="width: 40px; height: 40px">
            </a>
            <!-- LOGO -->
                        ...
                        <div class="d-flex order-lg-2">
                            ...
                            <div class="dropdown d-flex profile-1">
                                <a href="javascript:void(0)" data-bs-toggle="dropdown" class="nav-link leading-none d-flex">
                                    <img src="{{ asset('general/imgs/favicon.png') }}" alt="profile-user"
