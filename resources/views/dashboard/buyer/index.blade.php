                                    ...
                                    @foreach ($buyers as $buyer)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="btn-group">
                                                    @if($buyer->is_banned == 0)
                                                    <form method="post" action="{{ route('users.ban', $buyer->id) }}">
                                                        @csrf
                                                    ...
                                                    @else
                                                    <form method="post" action="{{ route('users.unban', $buyer->id) }}">
                                                        @csrf
                                                    ...
                                                    @endif
                                                    <form method="post" action="{{ route('users.destroy', $buyer->id) }}">
                                                        @method('delete')
                                                        @csrf
                                                        <button type="submit" onclick="return confirm('Are you sure you want to delete this user?')" class="btn btn-sm btn-danger" style="border-top-left-radius: 0; border-bottom-left-radius: 0"><i class="fa fa-trash"></i></button>
                                                    </form>
                                                </div>
                                            </td>
