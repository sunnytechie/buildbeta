            ...
            <div class="col-md-8" style="height: 100vh">
                <div class="d-flex justify-content-end">
                    <div class="px-5 pt-5 pb-1">
                        <p class="text-center">Don't have an account? <a href="{{ route('login') }}" class="border border-primary text-primary">Sign In</a></p>
                    </div>
                </div>
                ...
                <div class="col-md-6 offset-md-3">
                    <div class="py-5">
                        <div class="pb-4">
                            <h2 style="font-style: normal; font-weight: 700; font-size: 20px; line-height: 160%; letter-spacing: -0.3px; color: #0080E6;">Welcome to BuildBeta</h2>
                            <p style="font-style: normal; font-weight: 400; font-size: 16px; line-height: 160%; letter-spacing: -0.3px; color: #000000;">Pick a sign up option</p>
                        </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <a href="{{ route('register') }}">
                                    <div class="card-body p-4">
                                        ...
                                        <p class="card-text" style="font-style: normal; font-weight: 400; font-size: 14px; line-height: 160%; letter-spacing: -0.3px; #000000">Signing up as a buyer into our platform allows you to get the best you need and also to get a reward for your patronage.</p>
                                    </div>
                                </a>
                                </div>
                            </div>
                            <div class="col-md-12">
                                ...
                                <a href="{{ route('seller.register') }}">
                                    <div class="card-body p-4">
                                        ...
                                        <p class="card-text" style="font-style: normal; font-weight: 400; font-size: 14px; line-height: 160%; letter-spacing: -0.3px; #000000">Numerous buyers are already looking for your products and services, sign up to meet them here.</p>
                                    </div>
                                </a>
                                </div>
                            </div>
                            <div class="col-md-12">
                                ...
                                <a href="{{ route('bbforce.register') }}">
                                    <div class="card-body p-4">
                                        ...
                                        <p class="card-text" style="font-style: normal; font-weight: 400; font-size: 14px; line-height: 160%; letter-spacing: -0.3px; #000000">Convert your recommendations and referrals into cash as you earn on the go through our bbforce affiliate program.</p>
                                    </div>
                                </a>
                                </div>
                            </div>
