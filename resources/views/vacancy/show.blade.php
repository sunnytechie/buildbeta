                ...
                <div class="card shadow border-0">
                        <div class="card-body">
                            <div class="d-flex">
                                ...
                                <h5 class="card-title mx-2 mt-3" style="font-style: normal; font-weight: 700; font-size: 16px; line-height: 160%;">The SANDBOX</h5>
                            </div>
                            
                            <h5 class="card-title my-4" style="font-style: normal; font-weight: 600; font-size: 16px; line-height: 160%;">Achitectural Designer</h5>
                            <span>Contract</span>. <span>Full time</span>. <span>Remote</span>
                            
                            <div><a href="#" class="btn bb-bg-btn my-5 px-5" style="text-decoration: none">APPLY</a></div>
                            
                            <p class="card-text mb-3" style="font-style: normal; color: #000000; font-weight: 400; font-size: 14px; line-height: 160%;">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Mollitia architecto aperiam unde, iusto non suscipit nesciunt cupiditate dolores animi iste culpa numquam nulla amet quaerat qui dolorem rerum, quisquam totam.</p>
